...
function TRZ_Init()
	...
	zonearray[3]={GetMapZones(3)};
 	-- DEBUG --
	--for i = 1, 3 , 1 do
        --    DEFAULT_CHAT_FRAME:AddMessage("Continent:" .. i);
	--    for j = 1, table.getn(zonearray[i]), 1 do
	--       DEFAULT_CHAT_FRAME:AddMessage("Zone:" .. j);
	--       DEFAULT_CHAT_FRAME:AddMessage("[" .. i .. "]" .. " [" .. j .. "] " .. zonearray[i][j]);
        --    end
        --end
