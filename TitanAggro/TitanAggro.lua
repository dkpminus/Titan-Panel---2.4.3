...
3.2
* Patch 2.4 ready
* Thanks to Solie @ Kirin Tor for beta testing
...
2.9
* Patch 1.12 ready
* Fixed TitanAggro Scanning tooltip. Now it will show the actual mobs that are on you/your party without any duplicates
...
function TitanAggro_UpdateStatus()
    ...
    if (UnitName("target") and UnitName("target") ~= "Unknown" and UnitName("targettarget") and UnitName("targettarget") ~= "Unknown" and UnitName("targettarget") ~= "Unknown Entity") then
    -- Target has a target
