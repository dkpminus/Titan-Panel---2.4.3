...
function TitanPanelRightClickMenu_Toggle()
	...
	-- Toggle menu
	--support for Titan Gold Tracker Right click menu
	...
	local menu;	
   if this:GetName() == "TitanPanelBarButtonHider" or this:GetName() == "TitanPanelAuxBarButtonHider" then
   menu = getglobal("TitanPanelBarButton".."RightClickMenu");
   else
	menu = getglobal(this:GetName().."RightClickMenu");
	 end
